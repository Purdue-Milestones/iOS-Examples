...
extension MainViewController: SideMenuViewControllerDelegate {
    func selectedCell(_ row: Int) {
        ...
        case 0:
                ...
                case 1:
                    // HR
                    self.showViewController(viewController: UINavigationController.self, storyboardId: "HRNavID")
                case 2:
                    // HR Table
                    self.showViewController(viewController: UINavigationController.self, storyboardId: "HRTableNavID")
        default:
            break
        }
